<template>
    <div class="LOGOWANIE">
      ...
      <div class="LG">
        ...
        <div>
          <img title="Welcome" class="skynet-division" src="../../assets/img/skynet-division-png.png" alt="SKYNET DIVISION"/>
        </div>
      </div>
    </div>
  </template>
  ...
  <style scoped>
   .icon {
    fill: var(--primary);/* Ustaw wypełnienie ścieżki na aktualny kolor */
  }
